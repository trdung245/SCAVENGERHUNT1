...
public class LibrariesForLibsInPluginsBlock extends AbstractExternalDependencyFactory {
    ...
    public static class BcpkixLibraryAccessors extends SubDependencyFactory {
        ...
        /**
         * Dependency provider for <b>jdk15on</b> with <b>org.bouncycastle:bcpkix-jdk15on</b> coordinates and
         * with version reference <b>bcpkixJdk15on</b>
         * <p>
         * This dependency was declared in catalog libs.versions.toml
         *
         * @deprecated Will be removed in Gradle 9.0.
    ...
    public static class GithubLibraryAccessors extends SubDependencyFactory {
        private final GithubJavaLibraryAccessors laccForGithubJavaLibraryAccessors = new GithubJavaLibraryAccessors(owner);

        public GithubLibraryAccessors(AbstractExternalDependencyFactory owner) { super(owner); }

        /**
         * Group of libraries at <b>github.java</b>
         *
         * @deprecated Will be removed in Gradle 9.0.
         */
        @Deprecated
        public GithubJavaLibraryAccessors getJava() {
            org.gradle.internal.deprecation.DeprecationLogger.deprecateBehaviour("Accessing libraries or bundles from version catalogs in the plugins block.").withAdvice("Only use versions or plugins from catalogs in the plugins block.").willBeRemovedInGradle9().withUpgradeGuideSection(8, "kotlin_dsl_deprecated_catalogs_plugins_block").nagUser();
            return laccForGithubJavaLibraryAccessors;
        }
     ...
     */
    @Deprecated
    public static class GithubJavaLibraryAccessors extends SubDependencyFactory {
        private final GithubJavaIpfsLibraryAccessors laccForGithubJavaIpfsLibraryAccessors = new GithubJavaIpfsLibraryAccessors(owner);

        public GithubJavaLibraryAccessors(AbstractExternalDependencyFactory owner) { super(owner); }

        /**
         * Group of libraries at <b>github.java.ipfs</b>
         *
         * @deprecated Will be removed in Gradle 9.0.
         */
        @Deprecated
        public GithubJavaIpfsLibraryAccessors getIpfs() {
            org.gradle.internal.deprecation.DeprecationLogger.deprecateBehaviour("Accessing libraries or bundles from version catalogs in the plugins block.").withAdvice("Only use versions or plugins from catalogs in the plugins block.").willBeRemovedInGradle9().withUpgradeGuideSection(8, "kotlin_dsl_deprecated_catalogs_plugins_block").nagUser();
            return laccForGithubJavaIpfsLibraryAccessors;
        }
     ...
     */
    @Deprecated
    public static class GithubJavaIpfsLibraryAccessors extends SubDependencyFactory {
        private final GithubJavaIpfsHttpLibraryAccessors laccForGithubJavaIpfsHttpLibraryAccessors = new GithubJavaIpfsHttpLibraryAccessors(owner);

        public GithubJavaIpfsLibraryAccessors(AbstractExternalDependencyFactory owner) { super(owner); }

        /**
         * Group of libraries at <b>github.java.ipfs.http</b>
         *
         * @deprecated Will be removed in Gradle 9.0.
         */
        @Deprecated
        public GithubJavaIpfsHttpLibraryAccessors getHttp() {
            org.gradle.internal.deprecation.DeprecationLogger.deprecateBehaviour("Accessing libraries or bundles from version catalogs in the plugins block.").withAdvice("Only use versions or plugins from catalogs in the plugins block.").willBeRemovedInGradle9().withUpgradeGuideSection(8, "kotlin_dsl_deprecated_catalogs_plugins_block").nagUser();
            return laccForGithubJavaIpfsHttpLibraryAccessors;
        }
     ...
     */
    @Deprecated
    public static class GithubJavaIpfsHttpLibraryAccessors extends SubDependencyFactory {

        public GithubJavaIpfsHttpLibraryAccessors(AbstractExternalDependencyFactory owner) { super(owner); }

        /**
         * Dependency provider for <b>client</b> with <b>com.github.ipfs:java-ipfs-http-client</b> coordinates and
         * with version reference <b>javaIpfsHttpClientVersion</b>
         * <p>
         * This dependency was declared in catalog libs.versions.toml
         *
         * @deprecated Will be removed in Gradle 9.0.
        ...
        public Provider<MinimalExternalModuleDependency> getClient() {
            org.gradle.internal.deprecation.DeprecationLogger.deprecateBehaviour("Accessing libraries or bundles from version catalogs in the plugins block.").withAdvice("Only use versions or plugins from catalogs in the plugins block.").willBeRemovedInGradle9().withUpgradeGuideSection(8, "kotlin_dsl_deprecated_catalogs_plugins_block").nagUser();
            return create("github.java.ipfs.http.client");
        }
    ...
    public static class SolanajLibraryAccessors extends SubDependencyFactory implements DependencyNotationSupplier {
        ...
        /**
         * Dependency provider for <b>v17</b> with <b>org.p2p:solanaj</b> coordinates and
         * with version reference <b>orgP2pSolanaj</b>
         * <p>
         * This dependency was declared in catalog libs.versions.toml
         *
         * @deprecated Will be removed in Gradle 9.0.
    ...
    public static class VersionAccessors extends VersionFactory  {
        ...
        /**
         * Version alias <b>bcpkixJdk15on</b> with value <b>1.68</b>
         * <p>
         * If the version is a rich version and cannot be represented as a
         * single version string, an empty string is returned.
         * <p>
         * This version was declared in catalog libs.versions.toml
         */
        public Provider<String> getBcpkixJdk15on() { return getVersion("bcpkixJdk15on"); }
        ...
        /**
         * Version alias <b>javaIpfsHttpClientVersion</b> with value <b>1.3.3</b>
         * <p>
         * If the version is a rich version and cannot be represented as a
         * single version string, an empty string is returned.
         * <p>
         * This version was declared in catalog libs.versions.toml
         */
        public Provider<String> getJavaIpfsHttpClientVersion() { return getVersion("javaIpfsHttpClientVersion"); }
        ...
        /**
         * Version alias <b>orgP2pSolanaj</b> with value <b>1.7</b>
         * <p>
         * If the version is a rich version and cannot be represented as a
         * single version string, an empty string is returned.
         * <p>
         * This version was declared in catalog libs.versions.toml
         */
        public Provider<String> getOrgP2pSolanaj() { return getVersion("orgP2pSolanaj"); }
